...
const typoVariants = cva('text-pretty', {
  variants: {
    variant: {
      h1: 'scroll-m-20 text-balance font-extrabold text-4xl tracking-tight md:text-5xl',
      h2: 'mb-[10px] scroll-m-20 text-balance font-semibold text-3xl tracking-tight',
      h3: 'mb-[10px] scroll-m-20 text-balance font-semibold text-2xl tracking-tight',
      h4: 'scroll-m-20 text-balance font-semibold text-xl tracking-tight',
      h5: 'scroll-m-20 text-balance font-semibold text-lg tracking-tight',
      h6: 'scroll-m-20 text-balance font-semibold text-base tracking-tight',
      p: 'text-pretty text-base [&:not(:last-child)]:mb-6',
      span: 'text-base',
      div: 'text-base',
      blockquote: 'mb-6 border-l-2 pl-6 text-base italic',
      ul: 'my-6 ml-6 list-disc text-base [&>li]:mb-2',
      inline_code:
