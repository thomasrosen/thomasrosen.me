            ...
            imageSrc ? (
              <Image
                ...
                className={cn(
                  ...
                  'transition-transform duration-300 ease-out-mini-bounce [.hover_&]:rotate-0 [.hover_&]:scale-100',

                  pickFakeRandom(['-rotate-12', '-rotate-6', '-rotate-3'], index * -1.5),
            ...
            <>
              ...
              <div
                className={cn(
                  ...
                  'transition-transform duration-300 ease-out-mini-bounce [.hover_&]:rotate-0 [.hover_&]:scale-90',
                  imageSrc
                    ? 'translate-x-1/4 translate-y-1/4 [.hover_&]:translate-x-1/8 [.hover_&]:translate-y-1/8'
                    : 'translate-x-1/2 translate-y-1/2',
                  pickFakeRandom(['rotate-3', 'rotate-6', 'rotate-12'], index * 1.5),
