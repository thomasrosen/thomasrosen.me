...
export function Timeline({ tags }: { tags?: string[] }) {
        ...
        return (
          <React.Fragment key={key}>
            ...
            >
              ...
              {isNewMonth ? <span>{getMonthName(parseInt(month))}</span> : null}
            </Typo> */}

            {entries.length > 0 && (
              <div
                key={`${year}-${month}-${day}`}
                className='mygrid gap-4 place-content-center place-items-center mb-8'
              >
