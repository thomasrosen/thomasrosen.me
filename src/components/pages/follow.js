...
export default function Contact() {
  return <div className="tab_content">
    ...
    <div className="links_grid">
      ...
      <a href="https://gitlab.com/thomasrosen" target="_blank" rel="noreferrer" className="umami--click--gitlab">
        thomasrosen
      </a>
      ...
      <a href="https://subreply.com/thomasrosen" target="_blank" rel="noreferrer" className="umami--click--subreply">
        thomasrosen
      </a>

      <h3><Dot color="#2f93d7" />Mastodon</h3>
      <a href="https://mastodon.social/@thomasrosen" target="_blank" rel="noreferrer" className="umami--click--mastodon">
        thomasrosen
      </a>
      ...
      <a href="https://thomasrosen.tumblr.com/" target="_blank" rel="noreferrer" className="umami--click--tumblr">
        thomasrosen
      </a>

      <h3><Dot color="#e60023" />Pinterest</h3>
      <a href="https://www.pinterest.com/thomas_roses/" target="_blank" rel="noreferrer" className="umami--click--pinterest">
        thomas_roses
      </a>

      <h3><Dot color="#1067d9" />Flickr</h3>
      <a href="https://www.flickr.com/photos/116207237@N03/" target="_blank" rel="noreferrer" className="umami--click--flickr">
        Thomas Rosen
      </a>

      <h3><Dot color="#ea4c89" />Dribbble</h3>
      <a href="https://dribbble.com/thomasrosen/likes" target="_blank" rel="noreferrer" className="umami--click--dribbble">
        thomasrosen/likes
      </a>

      <h3><Dot color="#7ebc6f" />OpenStreetMap</h3>
      <a href="https://www.openstreetmap.org/user/thomasrosen" target="_blank" rel="noreferrer" className="umami--click--openstreetmap">
        thomasrosen
      </a>
